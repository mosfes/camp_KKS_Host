    ...
    const initScanner = async () => {
      try {
        ...
        if (cameras && cameras.length > 0) {
          ...
          const finalBackCameras =
            backCameras.length > 0 ? backCameras : cameras;
        ...
        <div className="absolute bottom-4 left-0 right-0 px-4 z-10 flex flex-col gap-3">
          ...
          {zoomCapabilities && (
            <div className="bg-black/40 backdrop-blur-md rounded-full px-4 py-2 flex items-center gap-3">
              <ZoomOut className="text-white/70" size={18} />
              <input
              ...
              />
              <ZoomIn className="text-white/70" size={18} />
            </div>
          )}
