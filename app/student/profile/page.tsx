                    ...
                    <CardBody className="p-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <h2 className="text-xl font-semibold mb-1" style={{ color: '#2d3748' }}>
                                    {studentData.name}
                                </h2>
                        ...
                        <Card className="shadow-sm" style={{ backgroundColor: 'white' }}>
                            <CardBody className="p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="text-sm font-medium block mb-1" style={{ color: '#718096' }}>
                                            Name
                                        </label>
                            ...
                            <CardBody className="p-6">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <p style={{ color: '#2d3748' }}>{studentData.studentPhone}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium block mb-1" style={{ color: '#718096' }}>
                                            Parent Phone
                                        </label>
                                        <p style={{ color: '#2d3748' }}>{studentData.parentPhone}</p>
                                    </div>
                                </div>
                            </CardBody>
                        </Card>
                            ...
                            <CardBody className="p-6">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <p style={{ color: '#2d3748' }}>{studentData.homeroomTeacher}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium block mb-1" style={{ color: '#718096' }}>
                                            Teacher Phone
                                        </label>
                                        <p style={{ color: '#2d3748' }}>{studentData.teacherPhone}</p>
                                    </div>
                                </div>
                            </CardBody>
                        </Card>
