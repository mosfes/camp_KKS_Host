...
import { MapPin, Calendar, Clock, ChevronLeft, Flag, CheckCircle2, Ticket, Shirt, LayoutDashboard } from "lucide-react";
                    ...
                    <div className="bg-white rounded-3xl shadow-sm p-6 mb-6">
                        ...
                        <div className="h-48 bg-gray-200 rounded-xl mb-6 overflow-hidden relative">
                            ...
                            <div className="w-full h-full bg-gray-800 flex items-center justify-center text-white">
                                <span className="font-mono tracking-widest text-xl">เสื้อค่าย</span>
                            </div>
                        </div>
                    ...
                    {!camp.isRegistered ? (
                        ...
                        <>
                            <Button
                                ...
                                onPress={() => router.push(`/student/dashboard/camp/${id}/missions`)}
                            >
                                ไปยังหน้าภารกิจ
                            </Button>

                            <div className="grid grid-cols-2 gap-3">
                                <Button variant="flat" className="bg-[#F5F1E8] text-[#5C5C5C]" startContent={<Ticket size={18} />}>
                                    เกียรติบัตร
                                </Button>
                                <Button variant="flat" className="bg-[#F5F1E8] text-[#5C5C5C]" startContent={<CheckCircle2 size={18} />}>
                                    เช็คชื่อ
                                </Button>
                            </div>
                        </>
