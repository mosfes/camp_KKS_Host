    ...
    <Modal
      ...
      classNames={{
        base: pageMode
          ...
          : "bg-white rounded-2xl shadow-xl max-h-[90vh]",
                      ...
                      <div className="flex items-end justify-between gap-3">
                        <div>
                          ...
                          <p className="mt-1 text-sm font-bold text-[#244d3e]">
                            เช็กชื่อแล้ว {totalCheckedIn} จาก {results.length}{" "}
                            คน
                          </p>
                        </div>
                      ...
                      <div className="w-full md:w-48">
                        <Select
                          ...
                          classNames={{
                            ...
                            value: "text-sm font-semibold text-[#50645a]",
                          }}
                      ...
                      {activeRoundId ? (
                        ...
                        <div className="mt-5">
                          ...
                          <div className="mt-4 space-y-3">
                            ...
                            <Select
                              classNames={{
                                label: "text-[11px] font-bold text-[#63786c]",
                                trigger:
                                  "h-11 min-h-11 rounded-xl border-[#e1e9e4] bg-white shadow-none",
                                value: "text-sm font-semibold text-[#273a30]",
                              }}
                              label="วิธีเช็กชื่อ"
