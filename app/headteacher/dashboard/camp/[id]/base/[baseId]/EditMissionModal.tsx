...
export default function EditMissionModal({ isOpen, onClose, missionData, onSuccess }: EditMissionModalProps) {
    ...
    useEffect(() => {
        if (missionData) {
            ...
            if (missionData.mission_question && missionData.mission_question.length > 0) {
                if (currentType === "QUESTION_ANSWERING") {
                    ...
                    if (mcqs.length > 0) {
                        setMcqQuestions(mcqs.map((q: any) => ({
